...
class PolitiClearContract extends Contract {
  ...
  //FORMS
  async createArcs(ctx, key, description, initialNode, finalNode, creatorId, createdAt, totalVotes) {
    const asset = new Arcs(description, initialNode, finalNode, creatorId, createdAt, totalVotes);
  ...
  async updateArcs(ctx, key, description, initialNode, finalNode, creatorId, totalVotes) {
    if (!(await this.dataExists(ctx, key, "Arcs"))) {
    ...
    const arcUpdated = new Arcs(asset.description, asset.initialNode, asset.finalNode, asset.creatorId, asset.createdAt, asset.totalVotes);
    arcUpdated.updateArcs(description || "", initialNode || "", finalNode || "", creatorId || "", totalVotes);
  ...
  async updateNodes(ctx, key, description, nodeType, creatorId) {
    if (description === "" && nodeType === "" && creatorId === "") {
    ...
    nodesUpdated.updateNodes(description || "", nodeType || "", creatorId || "");
